...
export class AddUserTable1781553468282 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."user_contract_type_enum" AS ENUM('alternance', 'initial')`);
        await queryRunner.query(`CREATE TYPE "public"."user_rentree_enum" AS ENUM('janvier', 'octobre')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TYPE "public"."user_rentree_enum"`);
        await queryRunner.query(`DROP TYPE "public"."user_contract_type_enum"`);
        await queryRunner.query(`DROP TYPE "public"."user_promotion_enum"`);
    }
